...
namespace ETrade.WebUI.EmailServices
{
    public class MailHelper
    {
        ...
        public static bool SendEmail(string body, List<string> to, string subject, bool isHtml = true)
        {
            ...
            try
            {
                ...
                message.From = new MailAddress("thsn_cnplt@windowslive.com");
                ...
                using (var smtp = new SmtpClient("smpt-mail.outlook.com", 587))
                {
                    smtp.EnableSsl = true;
                    smtp.Credentials = new NetworkCredential("thsn_cnplt@windowslive.com", "UBY123456");
                    smtp.Send(message);
                    result = true;
                }
